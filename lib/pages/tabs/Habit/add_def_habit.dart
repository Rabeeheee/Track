...
class AddDefHabit extends StatelessWidget {
  ...
  final List<Habit> suggestedHabits = [
    ...
    Habit(
        title: "Eat breakfast",
        subtitle: "Life begins after breakfast",
        image: 'assets/images/breakfast.jpeg'),
    Habit(
        title: "Eat fruit",
        subtitle: "Stay healthier, stay happier",
        image: 'assets/images/fruit.jpeg'),
    Habit(
        title: "Early to rise",
        subtitle: "Get up and be amazing",
        image: 'assets/images/sun.jpeg'),
    Habit(
        title: "Learn new words",
        subtitle: "Small number, big result",
        image: 'assets/images/words.jpg'),
    Habit(
        title: "Read",
        subtitle: "A chapter a day will light your day",
        image: 'assets/images/read.jpeg'),
    Habit(
        title: "Early to bed",
        subtitle: "Dream lofty dreams",
        image: 'assets/images/sleep.jpeg'),
    Habit(
        title: "Meditate",
        subtitle: "Quiet your mind and let the soul speak",
        image: 'assets/images/meditate.jpeg'),
  ];
